      ...
      <form onSubmit={handlerFormSubmit} className='flex flex-col'>
            ...
            <div className='w-32 h-32 self-center cursor-pointer relative my-5' onClick={()=> filePickerRef.current.click()}>
              ...
              />
                ...
                <img src={formDatas.imageFileUrl || currentUser.user.ProfilePhoto}   className={` rounded-full w-full h-full border-8  border-[lightgray] object-cover ${imageFileUploadingProgress && imageFileUploadingProgress < 100 && 'opacity-60'}`}/>
            </div>
